...
hold on
h51 = plot(tau_array,cond_ent2{c2}(c2,:), ':','LineWidth',2.5, 'Color', [0.8500 0.3250 0.0980]);
...
hold on
h21 = plot(tau_array,cond_ent2_new{c2}(c2,:), '-','LineWidth',2.5, 'Color', [0.8500 0.3250 0.0980]);
