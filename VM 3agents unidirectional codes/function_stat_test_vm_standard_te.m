...
function function_stat_test_vm_standard_te(d,nbird,nsymbols,num_trail,num_noise,num_coupling,tau_max)
...
for bird1=1:nbird
    for bird2=1:nbird
        if bird1~=bird2
                    ...
                    for tau_ind=1:tau_max
                        ...
                        parfor trail1=1:num_trail
                            for trail2=1:num_trail
                                if trail1==trail2
                                    temp_true_te(trail1)=tran_ent_func_mohi(symbols{trail2}(bird2,d:end),...
                                        symbols{trail1}(bird1,d:end),nsymbols,tau);
                                else
                                    temp=tran_ent_func_mohi(symbols{trail2}(bird2,d:end),...
                                        symbols{trail1}(bird1,d:end),nsymbols,tau);
            ...
            save(['data_te/te_data_stat_test_bird_',num2str(bird1),'_',num2str(bird2),...
