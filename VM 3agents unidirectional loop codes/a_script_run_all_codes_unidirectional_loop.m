...
%%%%%%%% Conditional MT computation %%%%%%%%%%

function_conditional_modified_te_comput_vm(d,nbird,nsymbols,num_trail,num_noise,num_coupling,tau_max)

%%%%%% Monotonicity matric map %%%%%%
tau_max1=4;   % maximum time delay for momonotonicity comparison 
function_monotonicity_test_vm_conditional_modified_te(nbird,num_noise,num_coupling,tau_max1)

%%%%%%%% Statistical test of CMT %%%%%%%%%%
tau_max2=4;
function_stat_test_vm_conditional_modified_te(d,nbird,nsymbols,num_trail,num_noise,num_coupling,tau_max2)
