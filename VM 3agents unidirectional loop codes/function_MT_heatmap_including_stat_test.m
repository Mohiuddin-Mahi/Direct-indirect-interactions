...
function function_MT_heatmap_including_stat_test(font)
    ...
    for ind2=1:nbird
        ...
        if ind1~=ind2
            ...
            elseif ind1==2 && ind2==1
                mon_mt_21=mon_te_new;
                mt_pass_or_fail_21=mt_pass_or_fail;

            elseif ind1==3 && ind2==1
                mon_mt_31=mon_te_new;
                mt_pass_or_fail_31=mt_pass_or_fail;

            elseif ind1==3 && ind2==2
                mon_mt_32=mon_te_new;
                mt_pass_or_fail_32=mt_pass_or_fail;
...
mon_mt_31(mt_pass_or_fail_31(:,:,3)==0) = NaN;
mon_mt_31(mt_pass_or_fail_31(:,:,2)==0) = NaN;
mon_mt_31(mt_pass_or_fail_31(:,:,1)==0) = NaN;
h=heatmap(coup_array,noise_array,mon_mt_31,'CellLabelColor', 'None');
h.XLabel = 'Coupling strength$(w)$';
h.YLabel = ('Noise${(\eta)}$');
h.Title = {'($\mathbf{c}$)'};
h.NodeChildren(3).XAxis.Label.Interpreter = 'latex';
...
mon_mt_21(mt_pass_or_fail_21(:,:,3)==0) = NaN;
mon_mt_21(mt_pass_or_fail_21(:,:,2)==0) = NaN;
mon_mt_21(mt_pass_or_fail_21(:,:,1)==0) = NaN;
h=heatmap(coup_array,noise_array,mon_mt_21,'CellLabelColor', 'None');
h.XLabel = 'Coupling strength$(w)$';
h.YLabel = ('Noise${(\eta)}$');
h.Title = {'($\mathbf{d}$)'};
h.NodeChildren(3).XAxis.Label.Interpreter = 'latex';
...
mon_mt_32(mt_pass_or_fail_32(:,:,3)==0) = NaN;
mon_mt_32(mt_pass_or_fail_32(:,:,2)==0) = NaN;
mon_mt_32(mt_pass_or_fail_32(:,:,1)==0) = NaN;
h=heatmap(coup_array,noise_array,mon_mt_32,'CellLabelColor', 'None');
h.XLabel = 'Coupling strength$(w)$';
h.YLabel = ('Noise${(\eta)}$');
h.Title = {'($\mathbf{e}$)'};
h.NodeChildren(3).XAxis.Label.Interpreter = 'latex';
