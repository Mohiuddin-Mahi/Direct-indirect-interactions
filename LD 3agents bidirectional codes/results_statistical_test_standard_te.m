...
function results_statistical_test_standard_te(alpha,num_kT,nparticles,num_gamma,num_tau)

for ind1=1:nparticles
    for ind2=1:nparticles
        if ind1~=ind2

            load(['data_te/te_data_true_surr_part_',num2str(ind1),'_',num2str(ind2),...
            ...
            save(['data_te/te_results_stat_test_part_',num2str(ind1),'_',num2str(ind2),...
